...
const Hero = () => {
  return (
    <div className="hidden lg:flex h-screen w-full bg-cover bg-center flex-col" style={{ backgroundImage: `url(${Backgroundimage})` }}>
          ...
          <div className="gap-5 flex flex-col">
            <div>
              <h1
                ...
                className="text-5xl xl:text-7xl text-white"
              >
